...
@Component({
  selector: 'app-input',
  standalone: true,
  imports: [NgClass, MatInputModule, MatFormFieldModule, ReactiveFormsModule],
  viewProviders: [
    {
...
export class InputComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    const validators = this.isInputRequired
    ...
    this.formControl = this.parentFormGroup.controls[
      this.controlName
    ] as FormControl;
  }
